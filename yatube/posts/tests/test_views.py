...
class PostPagesTests(TestCase):
    ...
    def test_create_show_correct(self):
        """Проверка create."""
        context = {
    ...
    def test_index_page_show_correct_context(self):
        """Шаблон index.html с корректным контекстом."""
        response = self.authorized_client.get(reverse('posts:index'))
        self.check_post_info(response.context['page_obj'][0])

    def test_groups_page_show_correct_context(self):
        """Шаблон group_list.html с корректным контекстом."""
    ...
    def test_profile_page_show_correct_context(self):
        """Шаблон profile.html с корректным контекстом."""
        response = self.authorized_client.get(
            reverse(
                'posts:profile',
    ...
    def test_detail_page_show_correct_context(self):
        """Шаблон post_detail.html с корректным контекстом."""
        response = self.authorized_client.get(
            reverse(
                'posts:post_detail',
